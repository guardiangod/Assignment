HPE - Technical Assessment
# v1.0 - RyanLe - 22Dec2021

*Problem statement:*

Develop a service to provide these features:
...
3. Allow users to search for restaurants by menu item like Paneer Tikka, name, address or geo location (within 5 kms radius), operation timings.
