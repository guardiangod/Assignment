...
export default class RestCard extends Component {
  ...
  render() {
    ...
    /*{
        "Restaurant ID" : 2222222,
        "Country Code" : 123,
        "City" : "Singapore",
        "Address" : "Raffle Place, 1 Raffle Place Rd, Downtown, Singapore",
        "Locality" : "Raffle Place, Downtown, Singapore",
        "Locality Verbose" : "Raffle Place, Downtown, Singapore City, Singapore",
